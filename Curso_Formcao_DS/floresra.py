...
credito = pd.read_csv('C:\\Users\\win10\\Desktop\\python_excel\\Formacao DC\\download\\Credit.csv')
...
novo_credito = pd.read_csv('C:\\Users\\win10\\Desktop\\python_excel\\Formacao DC\\download\\NovoCredit.csv')
...
vet = naive_bayes.predict(novo_credito)